...
values."
  (setq-default
   ...
   '(
     ...
     ;; TODO: unknown layer... revisit c++-rtags
     ;; ----------------------------------------------------------------
   ...
   dotspacemacs-additional-packages '(sublime-themes
                                      ...
                                      rtags              ; pseudo intellisense, but better :)
                                      )
...
values."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Consolas"
                               ...
                               :weight normal
                               :width normal
                               :powerline-scale 1.3) ;; originally 1.1
   ;; The leader key
...
`dotspacemacs/user-config' first."
  ...
  ;; NOTE: Just copy the 'snippets' folder to yasnippets after you include the 'yasnippets-snippets' package.
...
you should place your code here."
  ...
  (spacemacs/set-leader-keys "cc" 'user-compile)
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (disaster company-c-headers cmake-mode clang-format rtags yasnippet yasnippet-snippets helm-make google-translate fancy-battery yapfify pyvenv pytest pyenv-mode py-isort pip-requirements live-py-mode hy-mode dash-functional helm-pydoc cython-mode company-anaconda anaconda-mode pythonic powershell smeargle orgit magit-gitflow magit-popup helm-gitignore helm-company gitignore-mode gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link fuzzy evil-magit magit transient git-commit with-editor company-statistics company auto-yasnippet ac-ispell auto-complete ahk-mode rainbow-mode ws-butler winum which-key volatile-highlights vi-tilde-fringe uuidgen use-package toc-org spaceline powerline restart-emacs request rainbow-delimiters popwin persp-mode pcre2el paradox spinner org-plus-contrib org-bullets open-junk-file neotree move-text macrostep lorem-ipsum linum-relative link-hint indent-guide hydra lv hungry-delete hl-todo highlight-parentheses highlight-numbers parent-mode highlight-indentation helm-themes helm-swoop helm-projectile projectile pkg-info epl helm-mode-manager helm-flx helm-descbinds helm-ag golden-ratio flx-ido flx fill-column-indicator eyebrowse expand-region exec-path-from-shell evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-surround evil-search-highlight-persist highlight evil-numbers evil-nerd-commenter evil-mc evil-matchit evil-lisp-state smartparens evil-indent-plus evil-iedit-state iedit evil-exchange evil-escape evil-ediff evil-args evil-anzu anzu evil goto-chg undo-tree eval-sexp-fu elisp-slime-nav dumb-jump f dash s diminish define-word column-enforce-mode clean-aindent-mode bind-map bind-key auto-highlight-symbol auto-compile packed aggressive-indent adaptive-wrap ace-window ace-link ace-jump-helm-line helm avy helm-core popup async sublime-themes))))
(custom-set-faces
 ;; custom-set-faces was added by Custom.
 ;; If you edit it by hand, you could mess it up, so be careful.
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(header-line ((t (:background "NavajoWhite4" :foreground "#DEDEDE"))))
 '(helm-match ((t (:foreground "orange"))))
 '(helm-minibuffer-prompt ((t (:inherit minibuffer-prompt :background "NavajoWhite4" :foreground "old lace"))))
 '(helm-selection ((t (:background "ivory"))))
 '(helm-source-header ((t (:background "gray23" :foreground "gainsboro" :weight bold :height 1.0 :family "Consolas")))))
...
(defun user-display-config ()
  "Displays contents of the configuration file"
  (interactive)
  ;; (start-process "F:/Miscellaneous/Scripts/dev/display_config.bat")
  (shell-command "F:/Miscellaneous/Scripts/dev/display_config.bat")
  (other-buffer 1)
  )


(defun user-setup-devenv-for-schcvt-from-config ()
  "Setup everything needed for schematic translators source code editing and compiling. This routine is asynchronous, so if you want to check whether it's complete or not, you should check the *Messages* buffer."
  (interactive)
  (async-start-process
    ;; NAME
    "setup"
    ...
    ;; PROGRAM
    "F:/misc/scripts/dev/setup_environment.bat"

    ;; FINISH-FUNC
    (lambda (result)
      ;; TODO: Make it more obvious that the setup is done
      (message "Development environment set up by using data from configuration files")
      )
...
;; Compilation
;; Initially taken from Casey Muratori @ 5th minute mark and 34:43
;; https://www.youtube.com/watch?v=hbmV1bnQ-i0
(defun user-compile()
  "Compile and build sources."
  (interactive)
  ;; I don't know if I need the cmd script, I guess I don't, but I am too tired
  ;; to check it atm...
  (compile "f:/misc/scripts/emacs/build_nearest_vcxproj.cmd")
  (other-window 1)
  )
